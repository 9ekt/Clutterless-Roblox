setTimeout(() => {
    ...
    // support us message
    console.log("%c▶ Feel like Roblox is still too cluttered and want to contribute to this project? Feel free to at our github, we're open source! https://github.com/wutpreston/Clutterless-Roblox", "font-size:0.7rem;font-style:italic;color:orange;")
}, 1000)
